...
public interface IDocumentCTL extends Serializable {
    ...
    ResponseEntity<DocumentResponseDTO> create(HttpServletRequest request, @RequestBody DocumentDTO document,
            @PathVariable @Size(min = DEFAULT_STRING_MIN_SIZE, message = "identifier does not match the expected size") String identifier)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = ErrorResponseDTO.class))) })
    ResponseEntity<DocumentResponseDTO> replace(@RequestBody DocumentDTO body,
            @PathVariable @Size(min = DEFAULT_STRING_MIN_SIZE, max = DEFAULT_STRING_MAX_SIZE, message = "identifier does not match the expected size") String wii,
            HttpServletRequest request) throws OperationException, KafkaException, EmptyDocumentException,
            UnsupportedOperationException, DocumentNotFoundException;
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Dictionary non trovato sul database", content = @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = DocumentResponseDTO.class))),
            @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = ErrorResponseDTO.class))) })
    ResponseEntity<DocumentResponseDTO> update(HttpServletRequest request, @RequestBody DocumentDTO body)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = ErrorResponseDTO.class))) })
    ResponseEntity<DocumentResponseDTO> delete(HttpServletRequest request,
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = MediaType.APPLICATION_PROBLEM_JSON_VALUE, schema = @Schema(implementation = ErrorResponseDTO.class))) })
    ResponseEntity<DocumentDTO> getDocumentById(HttpServletRequest request,
