...
public interface IDocumentSRV {
     ...
     */
	StagingDocumentETY replace(DocumentDTO dto, String wii)throws OperationException, EmptyDocumentException, DocumentNotFoundException;
     ...
     * @throws DocumentNotFoundException 
     */
    Boolean update(final DocumentDTO dto) throws EmptyDocumentException, DocumentNotFoundException, ConnectionRefusedException, BusinessException;
